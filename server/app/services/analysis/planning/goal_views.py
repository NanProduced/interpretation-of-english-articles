...
_PROFILE_BASELINES: dict[str, str] = {
    ...
    "academic_general": (
        "用户是学术阅读者，需要理解论文、学术文献或专业材料。"
        "他们的核心目标不是'学英语'，而是'理解内容'——快速把握论文结构、术语含义、论证逻辑和核心观点。"
        "他们可能有一定英语基础，但学术文本的特殊性（长句、术语、被动语态、复杂论证结构）会拖慢理解速度。"
        "所以：帮助他们快速识别学术结构、理解专业术语、理清论证关系，让他们能专注于内容本身而非语言障碍。"
    ),
    "exam_gaokao": (
