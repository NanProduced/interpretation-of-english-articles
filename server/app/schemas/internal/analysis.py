...
GrammarGranularity = Literal["focused", "balanced", "structural", "explicit_split", "structural_logic", "explicit_exam", "speed_support", "rhetorical"]
VocabularyPolicy = Literal["high_value_only", "exam_priority", "academic_priority", "semantic_nuance", "exam_depth", "literary_depth"]
